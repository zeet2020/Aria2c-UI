  ...
  export default {
    ...
    methods: {
      handleThemeChange (theme) {
        ...
        // Apply the theme live on click (preview); Save persists it.
        this.$store.dispatch('preference/updateAppTheme', theme)
      },
      ...
      submitForm (formName) {
        this.$refs[formName].validate((valid) => {
          if (!valid) {
            console.error('[AUI] preference form valid:', valid)
            return false
          }
          ...
          console.log('[AUI] preference changed data:', data)
