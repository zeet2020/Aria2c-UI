  ...
  >
    ...
    >
      <el-tab-pane name="general">
        <template #label><span class="task-detail-tab-label"><el-icon><InfoFilled /></el-icon></span></template>
        <mo-task-general :task="task" />
      </el-tab-pane>
      <el-tab-pane name="activity" lazy>
        <template #label><span class="task-detail-tab-label"><el-icon><Grid /></el-icon></span></template>
        <mo-task-activity ref="taskGraphic" :task="task" />
      </el-tab-pane>
      <el-tab-pane name="trackers" lazy v-if="isBT">
        <template #label><span class="task-detail-tab-label"><el-icon><Share /></el-icon></span></template>
        <mo-task-trackers :task="task" />
      </el-tab-pane>
      <el-tab-pane name="peers" lazy v-if="isBT">
        <template #label><span class="task-detail-tab-label"><el-icon><UserFilled /></el-icon></span></template>
        <mo-task-peers :peers="peers" />
      </el-tab-pane>
      <el-tab-pane name="files" lazy>
        <template #label><span class="task-detail-tab-label"><el-icon><Files /></el-icon></span></template>
        <mo-task-files
          ref="detailFileList"
          mode="DETAIL"
          :files="fileList"
