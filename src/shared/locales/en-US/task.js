export default {
  ...
  'uri-task-tips': 'One task url per line (supports magnet). Drop a .txt here to import a list.',
  'upload-txt': 'Upload .txt list',
  'upload-txt-invalid': 'Please choose a .txt file',
